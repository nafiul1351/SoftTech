                        ...
                        <div class="tab-content">
                            ...
                            <div id="tab3" class="tab-pane fade in">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div id="review-form">
                                            <p style="font-weight: bold; text-align: center;">{{ __('To rate this product please purchase the product and then submit your review once the product is delivered.') }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
