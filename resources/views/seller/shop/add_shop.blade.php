            ...
            <div class="row row-offcanvas row-offcanvas-right">
                ...
                @include('seller.partials.sidebar')
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{ route('add.shop') }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="shopname" type="text" class="form-control @error('shopname') is-invalid @enderror" name="shopname" placeholder="Please enter the shop name" value="{{ old('shopname') }}" required autocomplete="shopname" autofocus>
                                        @error('shopname')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
