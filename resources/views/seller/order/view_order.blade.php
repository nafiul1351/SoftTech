                                        ...
                                        <div id="review-form">
                                            @if(!$orderdetail->reviews()->exists())
                                                ...
                                                @elseif($orderdetail->status == 'Canceled')
                                                    <h4 style="color: #DA0024;">{{ __('Sorry, this order is canceled. Buyer can not rate this product.') }}</h4>
                                                @else
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="tab-content" id="pills-tabContent">
                                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                                        ...
                                                        <p style="font-weight: bold;"><span>&#183;</span> {{ __('Phone Number:') }} {{$orderdetail->phonenumber}}</p>
                                                        <p style="font-weight: bold;"><span>&#183;</span> {{ __('Address:') }} {{$orderdetail->shippingaddress}}</p>
